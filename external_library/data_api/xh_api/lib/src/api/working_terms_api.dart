...
class WorkingTermsApi {
  ...
  Future<Response<WorkingTermModel>> apiWorkingTermsDetailsGet({ 
    ...
    final _path = r'/api/working-terms/details';
    ...
    WorkingTermModel _responseData;

    try {
      const _responseType = FullType(WorkingTermModel);
    ...
    return Response<WorkingTermModel>(
      data: _responseData,
  ...
  Future<Response<BuiltList<WorkingTermModel>>> apiWorkingTermsGet({ 
    ...
    final _path = r'/api/working-terms';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _responseType = FullType(BuiltList, [FullType(WorkingTermModel)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<BuiltList<WorkingTermModel>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
