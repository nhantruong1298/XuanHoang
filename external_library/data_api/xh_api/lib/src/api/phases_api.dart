...
class PhasesApi {
  ...
  Future<Response<PhaseModel>> apiPhasesDetailsGet({
    ...
    final _path = r'/api/Phases/details';
    ...
    PhaseModel _responseData;

    try {
      const _responseType = FullType(PhaseModel);
  ...
  Future<Object?> apiPhasesGet({
    ...
    try {
      const _responseType = FullType(BuiltList, [FullType(PhaseModel)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<BuiltList<PhaseModel>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
